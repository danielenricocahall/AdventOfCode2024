...
def find_occurrences_diagonally(puzzle: list[str]) -> int:
...
if __name__ == "__main__":
    with open('./puzzle.txt') as fp:
        ...
        diagonal_occurrences = find_occurrences_diagonally(puzzle)
        other_diagonal_occurrences = find_occurrences_diagonally(transpose_puzzle(puzzle))
